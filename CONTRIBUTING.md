...
There are opportunities to contribute to `tower-http` at any level. It doesn't
...
Don't know where to start? Check [issues labeled with "E-help-wanted"](https://github.com/tower-rs/tower-http/issues?q=is%3Aopen+is%3Aissue+label%3AE-help-wanted) or ["E-easy"](https://github.com/tower-rs/tower-http/issues?q=is%3Aopen+is%3Aissue+label%3AE-easy).
...
The `tower-http` project adheres to the [Rust Code of Conduct][coc]. This
...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in a `tower-http` crate, creating a new issue in the
   tower-rs/tower-http [issue tracker][issues] is the way to report it.
...
3. By helping to resolve the issue: Typically this is done either in the form of
   ...
   tower-http in a concrete and reviewable manner.

**Anybody can participate in any stage of contribution**. We urge you to
participate in the discussion around bugs and participate in reviewing PRs.

[issues]: https://github.com/tower-rs/tower-http/issues
...
When opening a new issue in the `tower-http` issue tracker, users will
...
and dependencies in the `tower-http` repository.
...
common use case) and another that shows how to customize things.

The examples should be provided in the module that contains the middleware. So
for `tower_http::trace::Trace` the examples should be in `tower_http::trace`.
The docs for the `Service` and `Layer` types should have a line that tells users
...
1. Does this change make sense for tower-http?
2. Does this change make tower-http better, even if only incrementally?
...
particular change that makes `tower-http` better, but the individual might just
not want to have anything to do with `tower-http` ever again. The goal is not
