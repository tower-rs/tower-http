use super::{
    DefaultClock, DefaultMakeSpan, DefaultOnBodyChunk, DefaultOnEos, DefaultOnFailure,
    DefaultOnRequest, DefaultOnResponse, GrpcMakeClassifier, HttpMakeClassifier, Trace,
};
use crate::classify::{
...
impl<M, MakeSpan, OnRequest, OnResponse, OnBodyChunk, OnEos, OnFailure, Clk>
    TraceLayer<M, MakeSpan, OnRequest, OnResponse, OnBodyChunk, OnEos, OnFailure, Clk>
{
    ...
    ) -> TraceLayer<M, MakeSpan, NewOnRequest, OnResponse, OnBodyChunk, OnEos, OnFailure, Clk> {
        TraceLayer {
    ...
    ) -> TraceLayer<M, MakeSpan, OnRequest, NewOnResponse, OnBodyChunk, OnEos, OnFailure, Clk> {
        TraceLayer {
    ...
    ) -> TraceLayer<M, MakeSpan, OnRequest, OnResponse, NewOnBodyChunk, OnEos, OnFailure, Clk> {
        TraceLayer {
    ...
    pub fn on_eos<NewOnEos>(
        self,
        new_on_eos: NewOnEos,
    ) -> TraceLayer<M, MakeSpan, OnRequest, OnResponse, OnBodyChunk, NewOnEos, OnFailure, Clk> {
        TraceLayer {
            on_eos: new_on_eos,
            on_body_chunk: self.on_body_chunk,
            on_failure: self.on_failure,
    ...
    ) -> TraceLayer<M, MakeSpan, OnRequest, OnResponse, OnBodyChunk, OnEos, NewOnFailure, Clk> {
        TraceLayer {
    ...
    ) -> TraceLayer<M, NewMakeSpan, OnRequest, OnResponse, OnBodyChunk, OnEos, OnFailure, Clk> {
        TraceLayer {
    ...
    pub fn with_clock<NewClock>(
        self,
        new_clock: NewClock,
    ) -> TraceLayer<M, MakeSpan, OnRequest, OnResponse, OnBodyChunk, OnEos, OnFailure, NewClock>
    {
        TraceLayer {
            clock: new_clock,
            on_request: self.on_request,
...
impl<S, M, MakeSpan, OnRequest, OnResponse, OnBodyChunk, OnEos, OnFailure, Clk> Layer<S>
    for TraceLayer<M, MakeSpan, OnRequest, OnResponse, OnBodyChunk, OnEos, OnFailure, Clk>
where
    M: Clone,
    MakeSpan: Clone,
    OnRequest: Clone,
    ...
    Clk: Clone,
{
    type Service = Trace<S, M, MakeSpan, OnRequest, OnResponse, OnBodyChunk, OnEos, OnFailure, Clk>;
